...
const ERA1_TREE = {
    ...
    dominance: {
        ...
        cost: { essence: 800, influence: 400 }, children: ['horde', 'colossus'],
        type: null, race: null,
    },
    wisdom: {
        ...
        cost: { essence: 800, influence: 400 }, children: ['anomaly', 'forged'],
        type: null, race: null,
    },
    growth: {
        ...
        cost: { essence: 800, influence: 400 }, children: ['root-node', 'changed'],
        type: null, race: null,
    },
    hunt: {
        ...
        cost: { essence: 800, influence: 400 }, children: ['pack', 'apex'],
        type: null, race: null,
    },
    undying: {
        ...
        cost: { essence: 800, influence: 400 }, children: ['kept', 'anchored'],
        type: null, race: null,
    },
    bargain: {
        ...
        cost: { essence: 800, influence: 400 }, children: ['pact', 'covenant'],
        type: null, race: null,
    },
    ...
    horde: {
        ...
        cost: { essence: 1200, influence: 800 }, children: ['type-goblinoid', 'type-swarm'],
        type: null, race: null,
    },
    colossus: {
    ...
    'type-goblinoid': {
        ...
        cost: { essence: 1600, influence: 1200, mana: 600 }, children: [],
...
(function buildRaceLeaves() {
    ...
    for (const def of RACE_LEAF_DEFS) {
        ...
        ERA1_TREE[nodeId] = {
            ...
            parent: l4Id,
            flavor: def.flavor,
            cost: { essence: 2000, influence: 1000, mana: 1000 },
            children: [],
            type: def.type,
            race: def.race,
        };
