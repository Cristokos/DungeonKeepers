...
const ERA1_TREE = {
    ...
    horde: {
        ...
        cost: { essence: 800, influence: 400 }, children: ['type-goblinoid', 'type-swarm'],
        type: null, race: null,
    },
    colossus: {
    ...
    'type-goblinoid': {
        ...
        cost: { essence: 1600, influence: 800, mana: 300 }, children: [],
...
(function buildRaceLeaves() {
    ...
    for (const def of RACE_LEAF_DEFS) {
        ...
        ERA1_TREE[nodeId] = {
            ...
            parent: l4Id,
            flavor: def.flavor,
            cost: { essence: 3200, influence: 1600, mana: 600 },
            children: [],
            type: def.type,
            race: def.race,
        };
